...
def main():
    ...
    if res.success:
        ...
        resulting_properties["Hardness"] = 200 + 50 * resulting_properties["C"] - 10 * resulting_properties["Si"]
        resulting_properties["Tensile Strength"] = 300 + 30 * resulting_properties["Mn"] - 5 * resulting_properties["Si"]
